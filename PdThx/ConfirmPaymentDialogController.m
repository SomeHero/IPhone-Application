...
@implementation ConfirmPaymentDialogController

@synthesize viewLoadedFromXib,btnCancelPayment, viewSecurityPinPlaceholder;
@synthesize delegate=_delegate;
@synthesize dialogTitle, dialogHeading;
...
- (id)initWithFrame:(CGRect)frame {
	if ((self = [super initWithFrame:frame])) {
		...
		[[NSBundle mainBundle] loadNibNamed:@"ConfirmPaymentDialog" owner:self options:nil];
