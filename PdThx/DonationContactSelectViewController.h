...
@interface DonationContactSelectViewController : UIBaseViewController <UITableViewDelegate, UITableViewDataSource, IconDownloaderDelegate, DetailInfoButtonClicked, SetContactProtocol, SetContactAndAmountProtocol>
{
