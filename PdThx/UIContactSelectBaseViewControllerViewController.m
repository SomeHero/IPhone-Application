//
//  UIContactSelectBaseViewControllerViewController.m
//  PdThx
//
...
@interface UIContactSelectBaseViewControllerViewController ()

- (void)startIconDownload:(Contact*)contact forIndexPath:(NSIndexPath *)indexPath;

@end

@implementation UIContactSelectBaseViewControllerViewController
...
-(void)refreshContactList:(NSNotification*)notification
{
    ...
    filteredResults = [[dict objectForKey:@"contacts"] mutableCopy];
