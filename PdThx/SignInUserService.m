...
-(void) validateUser:(NSString*) userName withPassword:(NSString*) password
{
    ...
    NSURL *urlToSend = [[[NSURL alloc] initWithString: [NSString stringWithFormat: @"http://dev.paidthx.com/api/internal/api/Users/validate_user?apiKey=%@", apiKey]] autorelease];  
