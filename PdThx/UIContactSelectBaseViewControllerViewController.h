//
//  UIContactSelectBaseViewControllerViewController.h
//  PdThx
//
...
@interface UIContactSelectBaseViewControllerViewController : UIViewController <UITableViewDelegate, UITableViewDataSource, FBRequestDelegate, IconDownloaderDelegate>
{
