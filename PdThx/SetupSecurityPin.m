...
@implementation SetupSecurityPin

@synthesize viewLoadedFromXib;
@synthesize viewSecurityPinPlaceholder;
@synthesize lblTitle, lblHeading;
...
- (id)initWithFrame:(CGRect)frame {
	if ((self = [super initWithFrame:frame])) {
		...
		[[NSBundle mainBundle] loadNibNamed:@"SetupSecurityPinDialog" owner:self options:nil];
...
-(void)unlockPatternView:(ALUnlockPatternView *)patternView selectedCode:(NSString *)code{
    ...
    [_delegate securityPinComplete:self selectedCode:code];
