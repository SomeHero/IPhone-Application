...
-(UIImage*)backgroundImage
{
    ...
    gradientTopColor = [UIColor colorWithRed:244/255.0 green:244/255.0 blue:244/255.0 alpha: 1];
    gradientMiddleColor = [UIColor colorWithRed:215/255.0 green:216/255.0 blue:220/255.0 alpha: 1];
    gradientBottomColor = [UIColor colorWithRed:187/255.0 green:190/255.0 blue:197/255.0 alpha: 1];
    ...
    if(self.isGradient){
        CGContextDrawLinearGradient(context, bgGradient, CGPointMake(0, bgRectPositionY+200), CGPointMake(0, bgRectPositionY), 0);
    }
